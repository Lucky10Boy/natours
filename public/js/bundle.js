...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibHVja3kxMGJveSIsImEiOiJja3doYzVwaHYwbDBiMnVtbGllNjE3cGFtIn0.wvSsNhPMsbrduoFSvKAYrQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/lucky10boy/ckwhcfsds15c814ocxcvorz0t',
    // style URL
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/form-data/lib/browser.js":[function(require,module,exports) {
...
var stripe = Stripe('pk_test_51K1wIxEt2dnaChYUp6oA4g9p8pg2YzYUD4aRcdEt1LOzMplmfWGtu0nCpsEGcWGQLznuq19BP2ET158J2N77q2GE00PInB44HY');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:8080/api/v1/bookings/checkout-session/".concat(tourId));
